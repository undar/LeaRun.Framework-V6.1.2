...
namespace LeaRun.Application.Busines.CustomerManage
{
    ...
    /// 描 述：干部基础
    /// </summary>
    public class Cadre_BaseBLL
    {
        private Cadre_BaseIService service = new Cadre_BaseService();
        #region 获取数据GetList
        /// <summary>
        /// 部门列表
        /// </summary>
        ...
        /// <returns></returns>
        public string Savephoto(string keyValue, Cadre_BaseEntity baseEntity)
        {
            try
            {
                 service.Savephoto(keyValue, baseEntity);
                return keyValue;
            }
            catch (Exception)
            {
