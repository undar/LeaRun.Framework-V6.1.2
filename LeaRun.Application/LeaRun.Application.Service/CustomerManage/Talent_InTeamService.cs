...
namespace LeaRun.Application.Service.CustomerManage
{
    ...
    /// 描 述：域内人才
    /// </summary>
    public class Talent_InTeamService : RepositoryFactory<Talent_InTeamEntity>, Talent_InTeamIService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<Talent_InTeamEntity> GetList(string queryJson)
        {
            var expression = LinqExtensions.True<Talent_InTeamEntity>();
        ...
        /// <returns></returns>
        public Talent_InTeamEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Talent_InTeamEntity entity)
        {
